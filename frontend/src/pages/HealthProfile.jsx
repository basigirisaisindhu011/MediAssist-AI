  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-slate-400">
        ...
        <p className="font-semibold text-sm animate-pulse">Loading patient health profile...</p>
      </div>
    );
  }
    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="glass-card p-6 sm:p-8 space-y-6 border border-slate-800">
        <form onSubmit={handleSave} className="space-y-6">
          ...
          <h2 className="text-lg font-bold text-slate-100 flex items-center space-x-2 border-b border-slate-800 pb-3 pt-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-800 bg-slate-900/80 text-slate-100 focus:ring-2 focus:ring-sky-500 text-sm"
                />
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full p-3.5 rounded-xl border border-slate-800 bg-slate-900/80 text-slate-100 focus:ring-2 focus:ring-sky-500 text-sm leading-relaxed"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={saving}
            className="w-full sm:w-auto px-8 py-3.5 rounded-xl text-white font-extrabold bg-gradient-to-r from-sky-500 to-teal-500 hover:from-sky-600 hover:to-teal-600 disabled:opacity-50 shadow-xl shadow-sky-500/20 flex items-center justify-center space-x-2 transition-all hover:scale-105"
          >
            {saving ? (
              <>
        ...
        <div className="h-64 w-full pt-4">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={vitalsTrendData}>
              ...
              <Bar dataKey="weight" fill="#38bdf8" name="Weight (kg)" radius={[6, 6, 0, 0]} />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </div>
